...
$username = "epiz_22752542";// dangerous
$password = "xXnGbWDGeIR3E38";// dangerous
$dbname = "epiz_22752542_Oefening1";// standaard test databank
...
if ($authentication_required) {
    ...
    // that should be modified for security in a production environment
        ...
        if (!$conn) {
            ...
            // de login nakijken
            $lQuery = "select * FROM users where NAME like '" . $_POST['name'] . "' and PW like '" . $_POST['password'] . "'";
